                    ...
                    <div className="col-md-8 text-center">
                        <div className="card shadow-lg">
                            <div className="card-body py-5">
                                ...
                                <h1 className="card-title mb-3">Bem-vindo ao Sistema de Gerenciamento de Usuários</h1>
                                <p className="card-text lead text-muted mb-4">
                                    Uma solução completa para gerenciar usuários com interface moderna e intuitiva.
                                </p>
                                <div className="d-grid gap-2 d-md-block">
                                    ...
                                    <Link to="/users/new" className="btn btn-outline-primary btn-lg">
                            ...
                            <div className="col-md-4 mb-3">
                                <div className="card h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text">Interface intuitiva para cadastrar novos usuários com validação em tempo real.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-3">
                                <div className="card h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text">Visualize todos os usuários em uma tabela responsiva com filtros e ações.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-3">
                                <div className="card h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text">Sistema seguro com autenticação JWT e controle de acesso.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p className="card-text">
                                        ...
                                        {user?.isAdmin ? 'Administrador' : 'Usuário'} • Sistema de Gerenciamento de Usuários
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-md-6 mb-3">
                    <div className="card h-100">
                        <div className="card-body text-center">
                            ...
                            <p className="card-text">Visualize, edite e gerencie todos os usuários do sistema.</p>
                ...
                <div className="col-md-6 mb-3">
                    <div className="card h-100">
                        <div className="card-body text-center">
                            ...
                            <p className="card-text">Cadastre novos usuários no sistema com informações completas.</p>
