                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="form-text">
                                        <i className="bi bi-info-circle me-1"></i>
                                        O endereço não pode ser alterado
                                    </div>
                                </div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input
                                        ...
                                        disabled
                                        title="Avatar não pode ser alterado"
                                        placeholder="Avatar não pode ser alterado"
                                    />
                                    <div className="form-text">
                                        <i className="bi bi-info-circle me-1"></i>
                                        O avatar não pode ser alterado
                                    </div>
                                </div>
                                ...
                                <div className="alert alert-info">
                                    ...
                                    <strong>Nota:</strong> Por questões de segurança, apenas nome, email e telefone podem ser editados.
                                </div>
